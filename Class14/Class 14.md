...
First, we’ll library our necessary packages and import relevant data
files:
...
4349 genes are upregulated and 4396 genes are downregulated with a
...
![](Class-14_files/figure-commonmark/unnamed-chunk-12-1.png)
...
```
    ...
    Info: Working in directory /Users/lilith.sadil/Desktop/RStudio Projects/bimm143_github/Class14
...
This code block above created a table txt file which can be uploaded to
the reactome website in order to visualize the pathway analysis in an
online browser.

This shows that the “cell cycle” pathway has the most significant
“entities P-value” at a value of 2.43E-4. This aligns with the KEGG
results since the first diagram we obtained through the KEGG analysis
was a cell cycle diagram (hsa04110). Different amounts of information
existing in each database may cause these results to vary slightly.
